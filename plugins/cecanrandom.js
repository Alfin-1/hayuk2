...
let handler = async (m, { conn }) => {
    ...
    if (!img) throw img
    await conn.sendFile(m.chat, img, '','© Nih Jgn lupa subscribe Channel FIN?OFFICIAL https://youtube.com/channel/UCCZFKpk85uGzGdGk9kUZUIA👍', m, 0, { thumbnail: await (await fetch(img)).buffer() })
}
